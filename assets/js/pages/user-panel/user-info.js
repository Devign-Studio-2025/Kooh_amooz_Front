...
class ProvinceCityManager {
    ...
    bindEvents() {
        ...
        $(this.selectors.province).on('change', this.handleProvinceChange.bind(this));
    ...
    setCityLoadingState(loading) {
        const $citySelect = $(this.selectors.city);
        if (loading) {
            $citySelect.empty().append('<option value="">در حال بارگذاری شهرها...</option>');
...
class FormStateManager {
    ...
    initializeValidation() {
        ...
        this.validator
            .addField("#first-name", [
                ...
                errorsContainer: document.querySelector("#first-name").closest(".input__with-error-wrapper"),
            })
            .addField("#last-name", [
                {
                    rule: "required",
                ...
                errorsContainer: document.querySelector("#last-name").closest(".input__with-error-wrapper"),
            })
            .addField("#email", [
                {
                    rule: "required",
                ...
                errorsContainer: document.querySelector("#email").closest(".input__with-error-wrapper"),
            })
            .addField("#phone", [
                {
                    rule: "required",
                ...
                errorsContainer: document.querySelector("#phone").closest(".input__with-error-wrapper"),
            })
            .addField("#date", [
                {
                    rule: "required",
                ...
                errorsContainer: document.querySelector("#date").closest(".input__with-error-wrapper"),
            })
            .addField("#gender", [
                {
                    rule: "required",
                ...
                errorsContainer: document.querySelector("#gender").closest(".input__with-error-wrapper"),
            })
            .addField("#province-select", [
                ...
                errorsContainer: document.querySelector("#province-select").closest(".input__with-error-wrapper"),
            })
            .addField("#city-select", [
                {
                    rule: "required",
                    errorMessage: "انتخاب شهر الزامی است",
                },
            ], {
                errorsContainer: document.querySelector("#city-select").closest(".input__with-error-wrapper"),
            })
            .onSuccess(() => {
    ...
    bindRealTimeValidation() {
        ...
        $(document).on('change', '.select2-province, .select2-city, #gender', () => {
            this.updateButtonState();
        });
...
class PasswordChangeManager {
    ...
    initializeValidation() {
        ...
        this.validator
            .addField("#current-password", [
                ...
                errorsContainer: document.querySelector("#current-password").closest(".input__with-error-wrapper"),
            })
            .addField("#new-password", [
                ...
                errorsContainer: document.querySelector("#new-password").closest(".input__with-error-wrapper"),
            })
            .onSuccess(() => {
    ...
    handlePasswordChangeSubmission() {
        ...
        if (buttonText) {
            ...
            toastr.success("رمز عبور جدید شما با موفقیت جایگزین شد.", "رمز عبور تغییر کرد.");
        }
...
$(document).ready(function () {
    ...
    console.log('Available managers: provinceCityManager, formStateManager, passwordChangeManager, passwordToggleManager');
});